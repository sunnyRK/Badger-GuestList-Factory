...
export interface BadgerWrapperAPIInterface extends utils.Interface {
  functions: {
...
export interface BadgerWrapperAPI extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: BadgerWrapperAPIInterface;
