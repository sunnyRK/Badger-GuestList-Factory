...
contract UniswapLPOracleFactory is Ownable {
    ...
    **/
    function createNewOracles(
        ...
        if (oracle1 == address(0)) {
            oracle1 = address(new UniswapLPOracleInstance(factory, token0, usdc_add));
        ...
        if (oracle2 == address(0)) {
            oracle2 = address(new UniswapLPOracleInstance(factory, token1, usdc_add));
            console.log('oracle2', oracle2);
    ...
    **/
    function getUnderlyingPrice(address _lpToken) public returns (uint256) {
        ...
        console.log('oracleAdds: ', oracleAdds[0], oracleAdds[1]);
        ...
        console.log('instanceTracker[oracleAdds[0]]: ', instanceTracker[oracleAdds[0]], instanceTracker[oracleAdds[1]]);
        ...
        console.log('priceAsset1:' , priceAsset1);
    ...
    function _calculatePriceOfLP(
        ...
        console.log('valuePerSupply: ', valueShifted, supplyShifted, valuePerSupply);
